...
public class Pro5 {
	@Test
	public static void addedtocart() throws InterruptedException
	{
        ...
        WebElement whishlist=driver.findElement(By.xpath("(//span[@class='a-button a-button-groupfirst a-spacing-none a-button-base a-declarative'])[1]"));
        whishlist.click();
        Thread.sleep(3000);
        //driver.navigate().refresh();
        WebElement listview=driver.findElement(By.linkText("View Your List"));
        listview.click();
